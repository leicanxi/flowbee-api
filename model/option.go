...
func InitOptionMap() {
	...
	common.OptionMap["ModelRequestRateLimitBalanceTier"] = setting.ModelRequestRateLimitBalanceTier2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ModelRequestRateLimitBalanceTier":
		err = setting.UpdateModelRequestRateLimitBalanceTierByJSONString(value)
	case "RetryTimes":
